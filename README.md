...
| Name | Example Value | How to get |
|------|-------|------------|
| SENTRY_AUTH_TOKEN | sntrys_eyJpYXQiOjE3MTYyNTky... | Go to Sentry -> Settings -> Auth Token |
| SENTRY_ORG | Sentry | Listed at the top left of sentry when logged in |
| SENTRY_PROJECT | tail_app | Whatever the project is named in sentry |
| SENTRY_URL | https://sentry.codel1417.xyz/ | The url to the sentry instance |
| FASTLANE_GITHUB | JeqGFIV1yb7emBFLkBk/dA== | echo -n your_github_username:your_personal_access_token \| base64
| APPLE | {"key_id": "D383SF739", "issuer_id": "6053b7fe-68a8-4acb-89be-165aa6465141", "key": "-----BEGIN PRIVATE KEY-----MIGTAgEAMB----END PRIVATE KEY-----", "in_house": false } | Json file of apple credentials https://docs.fastlane.tools/app-store-connect-api/
