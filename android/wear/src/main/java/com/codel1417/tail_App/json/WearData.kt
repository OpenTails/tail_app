...
data class WearLocalizationData(
    ...
    val phonAppClosed: String = "Please open 'The Tail Co' app on your phone to connect your gear."
)
...
data class WearThemeData(
    val primary: Long = 4293160486,
    val secondary: Long = 4285945929
)
