...
class ActionRegistry {
  static final Set<BaseAction> clawMoves = {
    CommandAction(
      name: "Extend Slow",
      command: "TAILS1",
      deviceCategory: [DeviceType.claws],
      response: "TAILS1 END",
      uuid: "a373f116-4c0a-4ab7-894d-caedc4e76d1d",
    ),
    CommandAction(
      name: "Extend Fast",
      command: "TAILS2",
      deviceCategory: [DeviceType.claws],
      response: "TAILS2 END",
      uuid: "9446d5a2-7178-4177-ad61-29f7e8980791",
    ),
    CommandAction(
      name: "1/2 Extend Slow",
      command: "TAILS3",
      deviceCategory: [DeviceType.claws],
      response: "TAILS3 END",
      uuid: "2eb1278a-d366-4406-99cd-26710dbd6417",
    ),
    CommandAction(
      name: "1/2 Extend Fast",
      command: "TAILFA",
      deviceCategory: [DeviceType.claws],
      response: "TAILFA END",
      uuid: "f17a781a-670e-4365-ba4b-18c8f503da56",
    ),
    CommandAction(
      name: "Retract Slow",
      command: "TAILSH",
      deviceCategory: [DeviceType.claws],
      response: "TAILSH END",
      uuid: "9074fb1f-1526-467e-8a84-a4752d9160f1",
    ),
    CommandAction(
      name: "Retract Fast",
      command: "TAILHA",
      deviceCategory: [DeviceType.claws],
      response: "TAILHA END",
      uuid: "08d19e6c-fed7-46b5-8c49-e019d74b5ac9",
    ),
    CommandAction(
      name: "Rawr",
      command: "TAILER",
  ...
  static final Set<BaseAction> earMoves = {
    ...
    CommandAction(
      ...
      response: "TAILS1 END",
      uuid: "a463cdb0-6d23-480b-9478-3db25828e764",
    ),
    CommandAction(
      name: "Slow left",
      command: "TAILS2",
      deviceCategory: [DeviceType.ears],
      response: "TAILS2 END",
      uuid: "c53e2db5-a425-4280-ba4b-91e193d7b445",
    ),
    CommandAction(
      name: "Slow Right",
      command: "TAILS3",
      deviceCategory: [DeviceType.ears],
      response: "TAILS3 END",
      uuid: "2518178a-c6b6-45c5-9bb0-9cf932e7f06a",
    ),
  ...
  static final Set<BaseAction> rgbCommands = {
    CommandAction(
      ...
      uuid: "3b40bd70-c90c-4939-a3e8-d3910a54cf9d",
    ),
    CommandAction(
      name: "Rainbow",
      command: "RGBRBW",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "f5cc3750-006c-4f89-be7c-36e4e3a16d39",
    ),
    CommandAction(
      name: "Rainbow Solid",
      command: "RGBSLD",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "0ce16767-bbab-4cd5-9c9c-421f7edad3ee",
    ),
    CommandAction(
      name: "Snow",
      command: "RGBSNO",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "cbaf45fb-45be-424a-a6e1-01ba49ceabee",
    ),
    CommandAction(
      name: "Twinkle",
      command: "RGBTWK",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "8e084317-13de-4bf5-a7ce-29a36021402c",
    ),
    CommandAction(
      name: "Wipe",
      command: "RGBWPE",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "b5d93f4d-cf9c-433d-a739-c7316e3008b0",
    ),
    CommandAction(
      name: "Fire",
      command: "RGBFIR",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "7837e80a-98d8-4eb1-8208-cb209579d511",
    ),
    CommandAction(
      name: "Demo",
      command: "RGBDMO",
    ...
    CommandAction(
      ...
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "a41946d6-1765-4e88-af00-85cdc51ae012",
    ),
    CommandAction(
      name: "Cyion",
      command: "RGBCLN",
      deviceCategory: DeviceType.values,
      actionCategory: ActionCategory.rgb,
      uuid: "04838672-461b-4818-a0c4-91bd92165579",
    ),
  };
  ...
  static final Set<BaseAction> miniTailMoves = {
    CommandAction(
      name: "Wag 1",
      command: "TAILS1",
      deviceCategory: [DeviceType.miniTail],
      response: "TAILS1 END",
      uuid: "f44b2ce8-ca8e-493c-98eb-74149e9ae0a5",
    ),
    CommandAction(
      name: "Wag 2",
      command: "TAILS2",
      deviceCategory: [DeviceType.miniTail],
      response: "TAILS2 END",
      uuid: "7e6cb80d-e78a-4179-8194-04f7068a43bb",
    ),
    CommandAction(
      name: "Wag 3",
      command: "TAILS3",
      deviceCategory: [DeviceType.miniTail],
      response: "TAILS3 END",
      uuid: "78a1304c-33ec-4722-b808-231deb2efc30",
    ),
    CommandAction(
      name: "Wag 4",
      command: "TAILFA",
  ...
  static final Set<BaseAction> flutterWingsMoves = {
    CommandAction(
      name: "Flutter 1",
      command: "TAILS1",
      deviceCategory: [DeviceType.wings],
      response: "TAILS1 END",
      uuid: "de9cb3f5-79a3-49aa-ab6d-1a21be9c88ff",
    ),
    CommandAction(
      name: "Flutter 2",
      command: "TAILS2",
      deviceCategory: [DeviceType.wings],
      response: "TAILS2 END",
      uuid: "c0868d65-0651-4697-b1f9-b5d641da6d83",
    ),
    CommandAction(
      name: "Flutter 3",
      command: "TAILS3",
      deviceCategory: [DeviceType.wings],
      response: "TAILS3 END",
      uuid: "7333bb98-a989-401a-9052-94b8374df34e",
    ),
    CommandAction(
      name: "Flap 1",
      command: "TAILFA",
      deviceCategory: [DeviceType.wings],
      response: "TAILFA END",
      uuid: "f404f3fe-c7e0-47f6-98a7-b231f799683e",
    ),
    CommandAction(
      name: "Flap 2",
      command: "TAILSH",
      deviceCategory: [DeviceType.wings],
      response: "TAILSH END",
      uuid: "9eb0a78c-027b-4a36-ab40-e7e36fe68f70",
    ),
    CommandAction(
      name: "Flap 3",
      command: "TAILHA",
      deviceCategory: [DeviceType.wings],
      response: "TAILHA END",
      uuid: "642855ef-d211-4ada-b737-ecd2aaf05ed2",
    ),
    CommandAction(
      name: "Flap 4",
      command: "TAILER",
      deviceCategory: [DeviceType.wings],
      response: "TAILER END",
      uuid: "4af89565-2612-4bdf-a6e3-61d38cf96fc1",
    ),
    CommandAction(
      name: "Rustles 1",
      command: "TAILEP",
      deviceCategory: [DeviceType.wings],
      response: "TAILEP END",
      uuid: "fbdc0003-a477-433e-9e07-ac2ac5323275",
    ),
    CommandAction(
      name: "Rustles 2",
      command: "TAILT1",
      deviceCategory: [DeviceType.wings],
      response: "TAILT1 END",
      uuid: "909fabdd-5403-4fb0-9e49-68bde1140647",
    ),
    CommandAction(
      name: "Rustles 3",
      command: "TAILT2",
      deviceCategory: [DeviceType.wings],
      response: "TAILT2 END",
      uuid: "5f7e16e4-04f6-46ab-bbc9-e6f908fc559c",
    ),
    CommandAction(
      name: "Rustles 4",
      command: "TAILET",
...
class GetActions with ChangeNotifier {
  static final GetActions instance = GetActions._internal();

  GetActions._internal() {
