...
class ActionRegistry {
  static Set<BaseAction> allCommands = {
    CommandAction("Slow wag 1", "TAILS1", [DeviceType.tail], ActionCategory.calm, "END TAILS1", "c53e980e-899e-4148-a13e-f57a8f9707f4"),
    CommandAction("Slow wag 2", "TAILS2", [DeviceType.tail], ActionCategory.calm, "END TAILS2", "eb1bdfe7-d374-4e97-943a-13e89f27ddcd"),
    CommandAction("Slow wag 3", "TAILS3", [DeviceType.tail], ActionCategory.calm, "END TAILS3", "6937b9af-3ff7-43fb-ae62-a403e5dfaf95"),
    CommandAction("Fast wag", "TAILFA", [DeviceType.tail], ActionCategory.fast, "END TAILFA", "a04b558f-0ad5-410f-8e39-8f5c594791d2"),
    CommandAction("Short wag", "TAILSH", [DeviceType.tail], ActionCategory.fast, "END TAILSH", "05a4c47b-45ee-4da8-bec2-4a46f4e04a7f"),
    CommandAction("Happy wag", "TAILHA", [DeviceType.tail], ActionCategory.fast, "END TAILHA", "86b13d13-b09c-46ba-a887-b40d8118b00a"),
    CommandAction("Erect", "TAILER", [DeviceType.tail], ActionCategory.fast, "END TAILER", "5b04ca3d-a22a-4aff-8f40-99363248fcaa"),
    CommandAction("Erect Pulse", "TAILEP", [DeviceType.tail], ActionCategory.tense, "END TAILEP", "39bbe39d-aa92-4189-ac90-4bb821a59f5e"),
    CommandAction("Tremble 1", "TAILT1", [DeviceType.tail], ActionCategory.tense, "END TAILT1", "8cc3fc60-b8d2-4f22-810a-1e042d3984f7"),
    CommandAction("Tremble 2", "TAILT2", [DeviceType.tail], ActionCategory.tense, "END TAILT2", "123557a2-5489-43da-99e2-da37a36f055a"),
    CommandAction("Erect Tremble", "TAILET", [DeviceType.tail], ActionCategory.tense, "END TAILET", "4909d4c2-0054-4f16-9589-6273ef6bf6c9"),
