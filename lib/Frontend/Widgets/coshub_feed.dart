...
class CoshubFeed extends StatefulWidget {
  ...
  @override
  State<CoshubFeed> createState() => _CoshubFeedState();
}

List<CosHubPost> results = [];

class _CoshubFeedState extends State<CoshubFeed> {
              ...
              child: Padding(
                ...
                child: Card(
                  ...
                  child: SizedBox(
                    ...
                    child: Semantics(
                      label:
                          'A button to view the CosHub post by: ${post.username}',
                      child: InkWell(
                        onTap: () async {
                          await launchExternalUrl(
                            url: post.url,
                            analyticsLabel: "CosHub Post",
                          );
                        },
                        child: Stack(
                          ...
                          children: <Widget>[
                            if (post.thumbnailUrl != "") ...[
                              SizedBox.expand(
                                child: TailBlogImage(url: post.thumbnailUrl),
                              ),
                            ],
                            Card(
                              clipBehavior: Clip.antiAlias,
                              ...
                              child: ListTile(
                                ...
                                title: Text(convertToUwU(post.username)),
                                subtitle: post.character != null
                                    ? Text(convertToUwU(post.character!))
                                    : null,
